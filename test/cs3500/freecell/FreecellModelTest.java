...
public class FreecellModelTest {
  ...
  //test to see if the game is restarted when startGame() is
  //called on a previously started game.
  @Test
  ...
  //changed since assignment 2: made next three tests' names more descriptive.

  //test moving to a foundation pile that doesn't exist
  @Test(expected = IllegalArgumentException.class)
  public void testMoveToInvalidPileFoundation() {
    SimpleFreecellModel model = new SimpleFreecellModel();
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testMoveToInvalidPileOpen() {
    SimpleFreecellModel model = new SimpleFreecellModel();
    ArrayList<Card> cards = model.getDeck();
    model.startGame(cards, 4, 4, false);
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testMoveToInvalidPileCascade() {
    SimpleFreecellModel model = new SimpleFreecellModel();
    ArrayList<Card> cards = model.getDeck();
    model.startGame(cards, 4, 4, false);
